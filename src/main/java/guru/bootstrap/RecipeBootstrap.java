...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        Optional<UnitOfMeasure> eachOumOptional = unitOfMeasureRepository.findByDescription("Each");

        if(!eachOumOptional.isPresent()){
        ...
        UnitOfMeasure eachUom = eachOumOptional.get();
        ...
        guacRecipe.getIngredients().add(new Ingredient("ripe tomato", new BigDecimal(2), eachUom, guacRecipe));
